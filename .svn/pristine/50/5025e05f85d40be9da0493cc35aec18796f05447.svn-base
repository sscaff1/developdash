 ...
 */
	public function add() {
		...
		$budgets = $this->Payment->Budget->find('list');
		$taxCredits = $this->Payment->TaxCredit->find('list');
		$loans = $this->Payment->Loan->find('list');
		$keyDates = $this->Payment->KeyDate->find('list');
		$frequencies = $this->Payment->Frequency->find('list');
		$rentTypes = $this->Payment->RentType->find('list');
		$units = $this->Payment->Unit->find('list');
		$this->set(compact('budgets', 'taxCredits', 'loans', 'keyDates', 'frequencies', 'rentTypes', 'units'));
	}
