<h2><?php echo __('Rent Type'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($rentType['RentType']['id']); ?>
			&nbsp;
		</dd>
		...
		<dd>
			<?php echo h($rentType['RentType']['name']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Created'); ?></dt>
		<dd>
			<?php echo h($rentType['RentType']['created']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Modified'); ?></dt>
		<dd>
			<?php echo h($rentType['RentType']['modified']); ?>
			&nbsp;
		</dd>
	</dl>
<div class="related">
	<h3><?php echo __('Related Payments'); ?></h3>
	<?php if (!empty($rentType['Payment'])): ?>
	...
	<?php foreach ($rentType['Payment'] as $payment): ?>
		<tr>
