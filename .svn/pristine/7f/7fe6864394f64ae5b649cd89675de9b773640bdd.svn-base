<h2><?php echo __('Unit'); ?></h2>
	<dl>
		...
		<dd>
			<?php echo h($unit['Unit']['number']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Sqft'); ?></dt>
		<dd>
			<?php echo h($unit['Unit']['sqft']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Beds'); ?></dt>
		<dd>
			<?php echo h($unit['Unit']['beds']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Baths'); ?></dt>
		<dd>
			<?php echo h($unit['Unit']['baths']); ?>
			&nbsp;
		</dd>
...
<div class="related">
	...
	<?php foreach ($unit['Payment'] as $payment): ?>
		<tr>
